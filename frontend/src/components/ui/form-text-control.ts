...
export const formTextControlClassName =
  "form-input-text h-8 w-full select-text rounded-md border border-gray-200 bg-white px-3 py-0 text-gray-900 outline-none transition placeholder:font-normal placeholder:text-gray-400 focus:border-[color:color-mix(in_srgb,var(--primary)_60%,transparent)] focus:ring-1 focus:ring-[color:color-mix(in_srgb,var(--primary)_15%,transparent)] focus-within:border-[color:color-mix(in_srgb,var(--primary)_60%,transparent)] focus-within:ring-1 focus-within:ring-[color:color-mix(in_srgb,var(--primary)_15%,transparent)] disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-400";
...
export const formTextControlErrorClassName =
  "border-destructive focus:!border-destructive focus:!ring-[color:color-mix(in_srgb,var(--destructive)_15%,transparent)] focus-within:!border-destructive focus-within:!ring-[color:color-mix(in_srgb,var(--destructive)_15%,transparent)]";
