    ...
    <div className="grid grid-cols-1 gap-4 xl:grid-cols-[minmax(300px,0.35fr)_minmax(0,0.65fr)]">
      <div className="grid auto-rows-fr grid-cols-2 gap-3">
        {Array.from({ length: 4 }).map((_, index) => (
          <div
            key={index}
            className="flex min-h-[82px] flex-col rounded-[18px] border border-slate-300 bg-white px-3 py-2"
          >
            <div className="h-3 w-16 rounded-full bg-slate-200" />
            <div className="mt-auto pt-1.5">
              <div className="h-5 w-12 rounded-md bg-slate-200" />
              <div className="mt-1 h-2.5 w-16 rounded-full bg-slate-200" />
            </div>
          </div>
        ))}
      </div>

      <div className="flex min-h-[160px] flex-col rounded-[22px] border border-slate-300 bg-white px-5 py-4">
        ...
        <div className="mt-3 flex items-center gap-4">
          <div className="h-7 w-14 shrink-0 rounded-md bg-slate-200" />
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-1.5 h-3 w-32 rounded-full bg-slate-200" />
          </div>
        </div>
        ...
        <div className="mt-3 grid grid-cols-2 gap-x-6">
          <div>
            ...
            <div className="mt-1.5 h-5 w-28 max-w-full rounded-md bg-slate-200" />
          </div>
          <div>
            <div className="h-3 w-16 rounded-full bg-slate-200" />
            <div className="mt-1.5 h-5 w-24 max-w-full rounded-md bg-slate-200" />
          </div>
        </div>

        <div className="mt-2 flex flex-wrap items-center gap-5 border-t border-slate-200 pt-2">
          {Array.from({ length: 3 }).map((_, index) => (
            <div key={index}>
              ...
              <div className="mt-1 h-4 w-20 max-w-full rounded bg-slate-200" />
            </div>
          ))}
        </div>
      </div>
